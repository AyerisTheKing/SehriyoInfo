...
const TEACHERS_DATA = [
    ...
    { name: 'Газизова Э.Р.', class: '1-А', classroom: '416', subject: 'Начальные классы' },
    { name: 'Романова Л.Ю.', class: '1-Б', classroom: '221', subject: 'Английский язык' },
    { name: 'Сучкова С.А.', class: '1-В', classroom: '418', subject: 'Начальные классы' },
    { name: 'Щекалева Е.В.', class: '1-Г', classroom: '322', subject: 'Начальные классы' },
    { name: 'Омарова И.А.', class: '2-А', classroom: '320', subject: 'Начальные классы' },
    { name: 'Шеварева И.А.', class: '2-Б', classroom: '319', subject: 'Начальные классы' },
    { name: 'Шишкина К.С.', class: '2-В', classroom: '218', subject: 'Начальные классы' },
    { name: 'Мавлюдова М.Г.', class: '2-Г', classroom: '316', subject: 'Начальные классы' },
    { name: 'Эшмухамедова Л.М.', class: '2-Д', classroom: '220', subject: 'Начальные классы' },
    { name: 'Недведцкая А.А.', class: '3-А', classroom: '320', subject: 'Начальные классы' },
    { name: 'Нурмухамедова Э.М.', class: '3-В', classroom: '415', subject: 'Начальные классы' },
    { name: 'Шакирова М.А.', class: '3-Г', classroom: '216', subject: 'Начальные классы' },
    { name: 'Самигулина Ю.В.', class: '3-Д', classroom: '220', subject: 'Начальные классы' },
    { name: 'Краева М.Ю.', class: '4-А', classroom: '318', subject: 'Начальные классы' },
    { name: 'Садыкова А.Я.', class: '4-Б', classroom: '414', subject: 'Начальные классы' },
    { name: 'Даминова Л.Ю.', class: '4-В', classroom: '420', subject: 'Начальные классы' },
    { name: 'Мухтарова С.Р.', class: '4-Г', classroom: '421', subject: 'Начальные классы' },
    { name: 'Гниенко О.А.', class: '4-Д', classroom: '422', subject: 'Начальные классы' },
    { name: 'Ахунзянова Г.Г.', class: '4-И', classroom: '219', subject: 'Начальные классы' },
    
    // ==================== СРЕДНЯЯ ШКОЛА (5-9 классы) ====================
    { name: 'Холмухамедова Н.С.', class: '5-А', classroom: '402', subject: 'Узбекский язык' },
    { name: 'Асимова М.Ю.', class: '5-Б', classroom: '306', subject: 'MBA' },
    { name: 'Родина А.В.', class: '5-В', classroom: '305', subject: 'Математика' },
    { name: 'Бабуц Е.С.', class: '5-Г', classroom: '401', subject: 'Начальные классы' },
    { name: 'Атабаева М.А.', class: '5-Д', classroom: '408', subject: 'Начальные классы' },
    { name: 'Ибрагимова Д.Д.', class: '6-А', classroom: '210', subject: 'MBA' },
    { name: 'Комлева Т.А.', class: '6-Б', classroom: '304', subject: 'Литература' },
    { name: 'Гурецкая М.В.', class: '6-В', classroom: '308', subject: 'MBA' },
    { name: 'Хабибова Л.', class: '6-Г', classroom: '300', subject: 'Начальные классы' },
    { name: 'Муратова О.С.', class: '6-Д', classroom: '208', subject: 'Начальные классы' },
    { name: 'Мирсаидова С.К.', class: '7-А', classroom: '406', subject: 'География' },
    { name: 'Арсланова Г.В.', class: '7-Б', classroom: '303', subject: 'MBA' },
    { name: 'Кадырова К.Ф.', class: '7-В', classroom: '407', subject: 'Начальные классы' },
    { name: 'Щербокова Е.В.', class: '7-Г', classroom: '301', subject: 'Литература' },
    { name: 'Сайдуллаева Н.В.', class: '7-Д', classroom: '310', subject: 'Английский язык' },
    { name: 'Нурутдинова М.У.', class: '8-А', classroom: '205', subject: 'Черчение' },
    { name: 'Дулянова А.Р.', class: '8-Б', classroom: '302', subject: 'История' },
    { name: 'Кузнецова Ю.А.', class: '8-В', classroom: '311', subject: 'История' },
    { name: 'Кабилджанова О.А.', class: '8-Г', classroom: '400', subject: 'Английский язык' },
    { name: 'Халимова В.А.', class: '8-Д', classroom: '212', subject: 'Математика' },
    { name: 'Каримова Э.А.', class: '9-Б', classroom: '403', subject: 'Информатика' },
    { name: 'Ямалетдинов Р.Ф.', class: '9-В', classroom: '211', subject: 'MBA' },
    { name: 'Мамадалиева Э.А.', class: '9-Д', classroom: '404', subject: 'Математика' },
    { name: 'Гафурова К.С.', class: '9-И', classroom: '410', subject: 'Английский язык' },
    
    // ==================== СТАРШАЯ ШКОЛА (10-11 классы) ====================
    { name: 'Галимов А.М.', class: '10', classroom: 'IT кабинет', subject: 'Информатика' },
    { name: 'Арапова А.А.', class: '11', classroom: '115', subject: 'Английский язык' },
    
    // ==================== ПРЕДМЕТНИКИ (без классов) ====================
    // История
    { name: 'Кузнецова Юлия', class: '', classroom: '', subject: 'История' },
    { name: 'Дулянова Адиля', class: '', classroom: '', subject: 'История' },
    { name: 'Расулова Мадина', class: '', classroom: '', subject: 'История' },
    // Литература
    { name: 'Мазитова Лилия', class: '', classroom: '', subject: 'Литература' },
    { name: 'Комлева Татьяна', class: '', classroom: '', subject: 'Литература' },
    { name: 'Арутюнова Эвелина', class: '', classroom: '', subject: 'Литература' },
    { name: 'Чиркова Марина', class: '', classroom: '', subject: 'Литература' },
    { name: 'Щербакова Елена', class: '', classroom: '', subject: 'Литература' },
    // Математика
    { name: 'Родина Светлана', class: '', classroom: '', subject: 'Математика' },
    { name: 'Расулова Шахиста', class: '', classroom: '', subject: 'Математика' },
    { name: 'Мамадалиева Эльвира', class: '', classroom: '', subject: 'Математика' },
    { name: 'Новикова Александра', class: '', classroom: '', subject: 'Математика' },
    { name: 'Халимова Венера', class: '', classroom: '', subject: 'Математика' },
    { name: 'Родина Александра', class: '', classroom: '', subject: 'Математика' },
    { name: 'Шакасымова Эльба', class: '', classroom: '', subject: 'Математика' },
    { name: 'Меньшикова Наталья', class: '', classroom: '', subject: 'Математика' },
    // География
    { name: 'Мирсаидова Сайера', class: '', classroom: '', subject: 'География' },
    // Физика
    { name: 'Назаров Файруз', class: '', classroom: '', subject: 'Физика' },
    { name: 'Худайберганова Дильдора', class: '', classroom: '', subject: 'Физика' },
    // Химия
    { name: 'Халходжаева Дильфуза', class: '', classroom: '', subject: 'Химия' },
    { name: 'Комарова Марина', class: '', classroom: '', subject: 'Химия' },
    // Биология
    { name: 'Мирзаукулова Мияссар', class: '', classroom: '', subject: 'Биология' },
    { name: 'Ильясова Анастасия', class: '', classroom: '', subject: 'Биология' },
    // Английский язык
    { name: 'Аракелян Ирина', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Арапова Аселя', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Кабилджанова Обида', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Гафурова Камила', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Садуллаева Наталья', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Таджибаева Мадина', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Романова Лали', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Ишмухамедова Асаль', class: '', classroom: '', subject: 'Английский язык' },
    { name: 'Кайпназарова Айгуль', class: '', classroom: '', subject: 'Английский язык' },
    // Информатика
    { name: 'Каримова Эмилия', class: '', classroom: '', subject: 'Информатика' },
    { name: 'Белова Елена', class: '', classroom: '', subject: 'Информатика' },
    // Музыка
    { name: 'Идоятов Тельман', class: '', classroom: '', subject: 'Музыка' },
    // Основы государства и права
    { name: 'Мадраимов Аскарий', class: '', classroom: '', subject: 'Основы государства и права' },
    // Технология
    { name: 'Мирзаахмедова Мухтабар', class: '', classroom: '', subject: 'Технология' },
    // Узбекский язык
    { name: 'Холмухамедова Нигорахон', class: '', classroom: '', subject: 'Узбекский язык' },
    { name: 'Холдарова Манзура', class: '', classroom: '', subject: 'Узбекский язык' },
    // Физкультура
    { name: 'Рахимов Акмаль', class: '', classroom: '', subject: 'Физкультура' },
    { name: 'Саляхова Аделина', class: '', classroom: '', subject: 'Физкультура' },
    { name: 'Фатхуллаев Рахматулла', class: '', classroom: '', subject: 'Физкультура' },
    // Черчение
    { name: 'Нурутдинова Михиринса', class: '', classroom: '', subject: 'Черчение' },
    // Футбол
    { name: 'Галеев Амир', class: '', classroom: '', subject: 'Футбол' },
    // Эмоциональный интеллект
    { name: 'Синюгина Светлана', class: '', classroom: '', subject: 'Эмоциональный интеллект' },
    // MBA
    { name: 'Арсланова Галина', class: '', classroom: '', subject: 'MBA' },
    { name: 'Ибрагимова Динара', class: '', classroom: '', subject: 'MBA' },
    { name: 'Асимова Мухайе', class: '', classroom: '', subject: 'MBA' },
    { name: 'Гурецкая Марина', class: '', classroom: '', subject: 'MBA' },
    { name: 'Ямалетдинов Рудиль', class: '', classroom: '', subject: 'MBA' },
    { name: 'Файзиева Малика', class: '', classroom: '', subject: 'MBA' }
];
...
function renderTeachersGrids(teachersBySubject) {
    document.querySelectorAll('.teachers-grid').forEach(grid => {
        ...
        if (subjectTeachers && subjectTeachers.length > 0) {
            ...
            grid.innerHTML = '<p class="empty-list-message">Информация об учителях буд��т добавлена позже</p>';
        }
    });
}
...
function openTeacherProfile(teacherName) {
    ...
    if (allTeacherClasses.length > 0) {
        ...
        classesContainer.innerHTML = '<p class="empty-list-message">Нет закреплённых классов</p>';
    }
